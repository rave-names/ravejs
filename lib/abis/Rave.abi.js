...
exports.raveabi = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'string', name: '_avatarLink', type: 'string' },
        ],
        name: 'AvatarUpdated',
        type: 'event',
    },
    {
        ...
        inputs: [
            { indexed: false, internalType: 'string', name: '_name', type: 'string' },
            { indexed: false, internalType: 'string', name: '_lnk', type: 'string' },
        ],
        name: 'LinkUpdated',
        type: 'event',
    },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'string', name: '_newURI', type: 'string' }],
        name: 'UpdatedURI',
        type: 'event',
    },
    {
    ...
    },
    {
        inputs: [
            { internalType: 'string', name: '_name', type: 'string' },
            { internalType: 'string', name: '_lnk', type: 'string' },
        ],
